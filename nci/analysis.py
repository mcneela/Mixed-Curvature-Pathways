...
df = pd.read_csv('ncbi/ncbi_all_data.tsv', sep='\t')
...
best_spaces = {}
best_space_counts = {}
with open('ncbi/ncbi_unique_best_spaces.tsv', 'w', newline='') as fpath:
    ...
    for i, graph_num in enumerate(df['Graph num'].unique()):
        ...
        graph_file = open(f'ncbi/{graph_num}/{graph_num}.edges', 'r')
...
with open('ncbi/general_stats.txt', 'w') as fpath:
