...
df = pd.read_csv('kegg/kegg_all_data.tsv', sep='\t')
...
best_spaces = {}
best_space_counts = {}
with open('kegg/kegg_unique_best_spaces.tsv', 'w', newline='') as fpath:
    ...
    for i, graph_num in enumerate(df['Graph num'].unique()):
        ...
        graph_file = open(f'kegg/{graph_num}/{graph_num}.edges', 'r')
...
with open('kegg/general_stats.txt', 'w') as fpath:
