...
mkdir humancyc_models

echo "Launching mixed curvature trainer"
python processing/generate_best_embeddings.py --space-file humancyc/humancyc_unique_best_spaces.tsv --dataset humancyc
# python run_euc_embs.py
