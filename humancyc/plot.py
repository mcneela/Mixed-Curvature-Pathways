...
df = pd.read_csv('humancyc_unique_best_spaces.tsv', sep='\t')
...
plt.title('Density Plot of Euclidean vs. Best Distortions (HumanCyc)')
plt.scatter(x, y, c=z, s=3)
plt.plot(xpoints, ypoints, linestyle='-', color='r', lw=2)
plt.savefig('scatterplot_density_humancyc.png')
plt.show()
